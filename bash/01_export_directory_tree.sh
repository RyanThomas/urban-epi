...
echo
echo "Enter the absolute path to the UEPI directory. (e.g. /home/user/projects/urban_epi/)"
...
if [ ! -d "$DIR" ]; then
  ...
  echo "Please enter the absolute path to the parent directory. Hint: This is the directory where you ran git clone. 
